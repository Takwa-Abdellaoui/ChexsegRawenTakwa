    ...
    <div className="analyze-container">
      ...
      {predictions.length > 0 && (
        <div className="results-section">
          ...
          Voici l’analyse de la radiographie pour les maladies pulmonaires. 
          Les maladies considérées comme positives sont celles dont la probabilité prédite dépasse le seuil de 50 %. 
          </p>
          ...
          {predictions.map((pred, idx) => (
            <div key={idx} className="prediction-block">
              ...
              <p>
                ...
                Il est recommandé de consulter un professionnel de santé pour une évaluation plus approfondie.
              </p>
            </div>
          ))}
