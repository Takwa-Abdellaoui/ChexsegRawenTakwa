...
model_path = "model.pth.tar"  # Remplace par le bon chemin si nécessaire
try:
...
image_path = "chexseg_data/images/00000001_000.png"  # Mets ici le chemin correct de ton image
try:
